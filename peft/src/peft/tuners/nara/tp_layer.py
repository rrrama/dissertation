...
class NARAParallelLinear(nn.Module, NARALayer):
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__()
        NARALayer.__init__(self, base_layer=base_layer)
    ...
    def forward(self, x: torch.Tensor, *args: Any, **kwargs: Any):
        ...
        if self.disable_adapters:
            ...
            for active_adapter in self.active_adapters:
                ...
                lora_result = self._apply_c(lora_result, c)
