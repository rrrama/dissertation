    ...
    def __init__(
        ...
        **kwargs,
        ...
        if r > 0 and any(enable_lora):
            in_features_lora = (in_features,)
            out_features_lora = (sum(enable_lora), n_head, in_features//n_head) 
            self.lora_linear = FactorizedLinear(in_features_lora, out_features_lora, rank=r, bias=False,implementation="reconstructed", factorization='CP')
            tensor_init(self.lora_linear.weight, std=10e-5)
